...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 136);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_1_NRF_HW_ASYNC_TIMER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_RX_BUFFERS, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DATA_LENGTH_MAX, 136);
