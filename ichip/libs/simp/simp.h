...
/******************************************************************
    Simp Simple Interprocessor Message Protocol
    Generall Message format:
    -------------------------------------------------------------
        Field     |  Type  |  Length  |  OPCODE  |  PDU  |  CRC  |
    -------------------------------------------------------------
        Length(byte) |    1    |    2     |    1     | >= 0  |   2   |
    -------------------------------------------------------------
...
*******************************************************************/
#define X_CMD_TYPE_REQUEST          0
#define X_CMD_TYPE_RESPONSE         1

#define CMD_FMT_START_REQ         0x42
#define CMD_FMT_START_RSP         0x69
